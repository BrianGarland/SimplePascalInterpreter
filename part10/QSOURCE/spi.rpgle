     ...
     D ListingLines    S              5U 0 INZ(0)
      ...
      /FREE
       ...
       Title = Center('SPI - Simple Pascal Interpreter');
       CurrentLine = 0;
     ...
     P Center          B
      //------------------------------------------------------------------------
     D Center          PI                  LIKE(Title)
     D  StringIn                    120A   VARYING CONST

     D Pos             S              5U 0
     D StringOut       S                   LIKE(Title) INZ

      /FREE

       Pos = (%SIZE(StringOut)/2+1) - (%LEN(StringIn)/2);
       %SUBST(StringOut:Pos) = StringIn;
       RETURN StringOut;
